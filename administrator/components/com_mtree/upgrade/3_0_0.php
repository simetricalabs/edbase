<?php
/**
 * @version	$Id: 3_0_0.php 1833 2013-03-14 13:43:27Z cy $
 * @package	Mosets Tree
...
class mUpgrade_3_0_0 extends mUpgrade {
	...
	function upgrade() {
		...
		JFolder::delete(JPATH_ROOT.DS.'tmp'.DS.'media');
	...
	function populate_fields_map()
	{
		...
		$cat_ids = $this->db->loadResultArray();
		
		$this->db->setQuery( 'SELECT cf_id FROM #__mt_customfields' );
		$cf_ids = $this->db->loadResultArray();
	...
	function copy_images_and_attachments_to_tmp()
	{
		$directories = array(
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'img'.DS.'listings'.DS.'s',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'s'
			),
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'img'.DS.'listings'.DS.'m',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'m'
			),
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'img'.DS.'listings'.DS.'o',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'o'
			),
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'img'.DS.'cats'.DS.'s',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'s'
			),
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'img'.DS.'cats'.DS.'o',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'o'
			),
			array(
				JPATH_ROOT.DS.'components'.DS.'com_mtree'.DS.'attachments',
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'attachments'
			)
		);
	...
	function copy_images_and_attachments_from_tmp_to_media()
	{
		$directories = array(
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'s',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'s'
			),
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'m',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'m'
			),
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'o',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'listings'.DS.'o'
			),
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'s',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'s'
			),
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'o',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'images'.DS.'cats'.DS.'o'
			),
			array(
				JPATH_ROOT.DS.'tmp'.DS.'media'.DS.'com_mtree'.DS.'attachments',
				JPATH_ROOT.DS.'media'.DS.'com_mtree'.DS.'attachments'
			)		
		);
		...
		foreach( $arrFolders AS $directory )
		{
			if( JFolder::exists($directory[0]) )
			{
				...
				foreach( $files AS $file )
				{
					...
					JFile::copy( $directory[0] . DS . $file, $directory[1] . DS . $file);
				}
