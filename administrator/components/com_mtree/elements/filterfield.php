<?php
/**
 * @version	$Id: filterfield.php 1172 2011-07-29 08:08:11Z cy $
 * @package	Mosets Tree
...
class JFormFieldFilterfield extends JFormField
{
	...
	*/
	...
	function getInput()
	{
		...
		$html .= JHTML::_('select.genericlist',  $customfields, $this->name.'[]', 'class="inputbox"', 'value', 'text', $this->value[0], $this->id);
		...
		$html .= JHTML::_('select.genericlist',  $operators, $this->name.'[]', 'class="inputbox"', 'value', 'text', $this->value[1], $this->id);
