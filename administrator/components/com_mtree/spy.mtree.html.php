<?php
/**
 * @version		$Id: spy.mtree.html.php 1512 2012-07-31 08:59:46Z cy $
 * @package		Mosets Tree
...
class HTML_mtspy {
	...
	<tr align="left">
		...
		<th width="5%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_HITS' ) ?></th>
		<th width="8%" nowrap="nowrap" align="center"><?php echo JText::_( 'COM_MTREE_CREATED' ) ?></th>
	</tr>
	</thead>
	<?php
		$c=0;
	...
	<table class="adminheading" width="100%">
		<tr><td>
			...
			<table cellpadding="3">
				<tr><td colspan="2"><b><a href="<?php echo $mtconf->getjconf('live_site') . '/index.php?option=com_mtree&task=viewlink&link_id=' . $listing->link_id . '&Itemid='.$Itemid; ?>" target="_blank"><?php echo JText::_( 'COM_MTREE_VIEW_LISTING' ) ?></a> | <a href="index.php?option=com_mtree&task=editlink&link_id=<?php echo $listing->link_id ?>"><?php echo JText::_( 'COM_MTREE_EDIT' ) ?></a></b></td></tr>
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_ACTION' ) ?>: </td>
					<td valign="top">
				...
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_OWNER' ) ?>: </td><td><b><?php echo mtfHTML::user( $listing->user_id, $listing->username, $listing->name ); ?></b></td></tr>
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_RATING' ) ?>: </td><td><?php echo mtfHTML::rating( $listing->link_rating ); echo '&nbsp; ' . $listing->link_rating . ' (<b>'.$listing->link_votes.' votes</b>)'; ?></td>
				</tr>
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_REVIEWS' ) ?>: </td><td><b><?php echo count($reviews); ?></b></td></tr>
			</table>
			...
			<table cellpadding="3">
				...
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_LISTING_ID' ) ?>: </td><td><b><?php echo $listing->link_id; ?></b></td></tr>
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_CREATED' ) ?>: </td><td><b><?php echo $listing->link_created; ?></b></td></tr>
				<tr><td align="right"><?php echo JText::_( 'COM_MTREE_MODIFIED' ) ?>: </td><td><b><?php echo $listing->link_modified; ?></b></td></tr>
			</table>
	...
	<tr align="left">
		<th width="5">#</th>
		<th width="45%"><?php echo JText::_( 'COM_MTREE_ACTIVITIES' ) ?></th>
		<th width="33%"><?php echo JText::_( 'COM_MTREE_USER' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_IP_ADDRESS' ) ?></th>
		<th width="12%" nowrap="nowrap" align="center"><?php echo JText::_( 'COM_MTREE_DATE' ) ?></th>
	</tr>
	</thead>
	<?php
	$clone_votes=0;
	...
	<table class="adminheading" width=100%>
		<tr>
			...
			<table cellpadding="1"><tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_LISTING_NAME' ) ?>: </td>
			...
			<table cellpadding="1"><tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_LISTING_ID' ) ?>: </td>
					<td><b><input class="text_area" type="text" name="link_id" size="24" value="<?php if (isset($search['link_id']) && $search['link_id'] > 0) echo $search['link_id'] ?>" /></b></td>
			</tr></table>

			</td></tr>

			<tr><td colspan="2"><input type="submit" value="<?php echo JText::_( 'COM_MTREE_SEARCH' ) ?>" /> <input type="reset" value="<?php echo JText::_( 'COM_MTREE_RESET' ) ?>" /></td></tr>
			</table>
	...
	<tr align="left">
		<th width="5">#</th>
		<th width="35%"><?php echo JText::_( 'COM_MTREE_LISTING' ) ?></th>
		<th width="22%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_OWNER' ) ?></th>
		<th width="20%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_RATINGS_AND_VOTES' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_REVIEWS' ) ?></th>
		<th width="5%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_HITS' ) ?></th>
		<th width="8%" nowrap="nowrap" align="center"><?php echo JText::_( 'COM_MTREE_CREATED' ) ?></th>
	</tr>
	</thead>
	...
	function removeClone(){
		...
		if(owner!='') {
			location.href = "index.php?option=com_mtree&task=spy&task2=removecloneandalllogs&id=<?php echo $user->id ?>&owner=" + owner + "&<?php echo JUtility::getToken(); ?>=1";
		}
	}
	<?php } ?>
	function perform_action(ref) {
		switch(ref.options[ref.selectedIndex].value) {
			...
			case '3':
				if( confirm('<?php echo JText::_( 'COM_MTREE_CONFIRM_REMOVE_USER_AND_ALL_ITS_DATA' ) ?>') ) {
					location.href = "index.php?option=com_mtree&task=spy&task2=removeuserandalllogs&id=<?php echo $user->id ?>&<?php echo JUtility::getToken(); ?>=1";
				}
				break;
			case '4':
	...
	<table class="adminheading" width="100%">
		<tr><td>
			...
			<table cellpadding="3">
				...
				<tr>
					<td align="right" valign="top"><?php echo JText::_( 'COM_MTREE_ACTION' ) ?>: </td>
					<td valign="top">
						<select id="action" class="text_area" onchange="perform_action(this)">
							<option value=''></option>
						...
						if(count($lists)>0) {
							...
							echo '<input type="button" onclick="removeClone()" value="' . JText::sprintf( 'COM_MTREE_REMOVE_USER_INCLUDING_HIS_HER_ACTIVITIES',$user->username ) . '" class="inputbox" />';
				...
				<?php } ?>
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_EMAIL' ) ?>: </td>
					<td><a href="mailto:<?php echo $user->email; ?>"><?php echo $user->email; ?></a></td>
				</tr>
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_USERNAME' ) ?>: </td>
					<td><b><?php echo $user->username; ?></b></td>
				</tr>
				<?php
				if(count($removed_clones)>0) {
					echo '<tr>';
					echo '<td align="right">' . JText::_( 'COM_MTREE_REMOVED_CLONES' ) . '(' . count($removed_clones) . '):</td>';
					echo '<td>';
			...
			<table cellpadding="3">
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_USER_ID' ) ?>: </td>
					<td><b><?php echo $user->id; ?></b></td>
				</tr>
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_REGISTER' ) ?>: </td>
					<td><b><?php echo $user->registerDate; ?></b></td>
				</tr>
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_LAST_VISIT' ) ?>: </td>
	...
	<tr align="left">
		...
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_IP_ADDRESS' ) ?></th>
		<th width="13%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_DATE' ) ?></th>
	</tr>
	</thead>
	<?php
	...
	<tr align="left">
		...
		<th width="20%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_RATINGS_AND_VOTES' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_REVIEWS' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_HITS' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_CREATED' ) ?></th>
		<th width="10%" nowrap="nowrap"><?php echo JText::_( 'COM_MTREE_MODIFIED' ) ?></th>
	</tr>
	</thead>
	<?php
	...
	<table class="adminheading" width=100%>
		<tr>
			...
			<table cellpadding="1">
				...
				<tr>
					<td align="right"><?php echo JText::_( 'COM_MTREE_NAME' ) ?>: </td>
	...
	<tr><td align="left" valign="top" width="160" height="0">
		<table cellpadding="2" cellspacing="0" border="0" width="160" height="100%" align="left" style="border: 1px solid #cccccc;background-color:#F1F3F5;clear:both;float:left;">
			<tr><td colspan="2" style="background: #DDE1E6; border-bottom: 1px solid #cccccc;font-weight:bold;"><?php echo JText::_( 'COM_MTREE_SPY_DIRECTORY' ) ?></td></tr>
			<tr>
				<td width="20"><img src="..<?php echo $mtconf->get('relative_path_to_images'); ?>group.png" width="16" height="16" /> </td>
				<td width="100%"><a href="index.php?option=com_mtree&task=spy&task2=users"><b><?php echo JText::_( 'COM_MTREE_VIEW_USERS' ) ?></b></a></td>
			</tr>
			<tr>
				<td><img src="..<?php echo $mtconf->get('relative_path_to_images'); ?>page_white.png" width="16" height="16" /> </td>
				<td><a href="index.php?option=com_mtree&task=spy&task2=listings"><b><?php echo JText::_( 'COM_MTREE_VIEW_LISTINGS' ) ?></b></a></td>
			</tr>
			<tr>
				<td><img src="..<?php echo $mtconf->get('relative_path_to_images'); ?>group_error.png" width="16" height="16" /> </td>
				<td><a href="index.php?option=com_mtree&task=spy&task2=clones"><b><?php echo JText::_( 'COM_MTREE_VIEW_CLONES' ) ?></b></a></td>
			</tr>

			<tr><td colspan="2" style="background: #DDE1E6; border-bottom: 1px solid #cccccc;font-weight:bold;"><?php echo JText::_( 'COM_MTREE_SEARCH_LISTINGS' ) ?></td></tr>
			<tr><td colspan="2">
				<form action="index.php" method="post" name="adminForm_searchlisting">
					<input type="text" name="link_name" class="text_area" style="width:100%" /> <input type="submit" value="<?php echo JText::_( 'COM_MTREE_GO' ) ?>" />
					<input type="hidden" name="option" value="<?php echo $option;?>" />
					<input type="hidden" name="task" value="spy" />
					<input type="hidden" name="task2" value="listings" />
				</form>
			...
			<tr><td colspan="2" style="background: #DDE1E6; border-bottom: 1px solid #cccccc;font-weight:bold;"><?php echo JText::_( 'COM_MTREE_SEARCH_USERS' ) ?></td></tr>
			<tr><td colspan="2">
				<form action="index.php" method="post" name="adminForm_searchlisting">
					<input type="text" name="username_name" class="text_area" style="width:100%" /> <input type="submit" value="<?php echo JText::_( 'COM_MTREE_GO' ) ?>" />
					<input type="hidden" name="option" value="<?php echo $option;?>" />
					<input type="hidden" name="task" value="spy" />
					<input type="hidden" name="task2" value="users" />
				</form>
		...
		<div style="position:relative;top:5px;clear:both;text-align:center;"><img style="position:relative;top:4px;" src="..<?php echo $mtconf->get('relative_path_to_images'); ?>arrow_left.png" width="16" height="16" /> <a href="index.php?option=com_mtree"><b><?php echo JText::_( 'COM_MTREE_BACK_TO_DIRECTORY' ) ?></b></a></div>
