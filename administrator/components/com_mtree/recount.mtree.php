<?php
/**
 * @version		$Id: recount.mtree.php 1692 2012-12-26 02:16:18Z cy $
 * @package		Mosets Tree
...
function recount( $method, $cat_id ) {
	...
	echo "<center><strong>".JText::_( 'COM_MTREE_PLEASE_WAIT_RECOUNT_IN_PROGRESS' )."</strong>";
	...
	echo '<p /><strong>'.JText::_( 'COM_MTREE_DONE' ).'</strong><p /><input type="button" class="button" value="'.JText::_( 'COM_MTREE_CLOSE_THIS_WINDOW' ).'" onclick="window.close();" /></center>';
}
?>