<?php
/**
 * @version		$Id: linkchecker.mtree.html.php 1200 2011-09-21 07:20:19Z cy $
 * @package		Mosets Tree
				...
				<tr>
					<td width="50%" valign="top">
						...
						<div id="advancedoptions" style="display:none">
							<table>
								<tr><td width="20"><input type="checkbox" id="togglelinks" onclick="toggleLinks()" class="text_area" /></td><td width="99%"><label for="togglelinks"><?php echo JText::_( 'COM_MTREE_SHOW_ALL_LINKS' ) ?></label></td></tr>
