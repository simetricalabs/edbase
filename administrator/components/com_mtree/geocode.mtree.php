<?php
/**
 * @version	$Id: geocode.mtree.php 1798 2013-02-06 08:12:27Z cy $
 * @package	Mosets Tree
			...
			<td width="620px" valign="top" id="listings">
				...
				<table width="100%" border=0 cellpadding=0 cellspacing=0>
					...
					<tfoot><tr><td colspan="2" align="right">
							<input type="button" value="Go" onclick="javascript:getListings(document.getElementById('numberOfListings').value);" style="float:right">
