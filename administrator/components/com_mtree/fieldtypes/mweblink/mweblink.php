<?php
/**
 * @version	$Id: mweblink.php 1416 2012-04-06 02:52:49Z cy $
 * @package	Mosets Tree
...
class mFieldType_mweblink extends mFieldType_weblink {
	...
	function getJSValidationFunction() {
		...
		return 'function(){return (arguments[0].value != "" && /^('.implode('|',$arrProtocolRegex).')?(([a-zA-Z0-9]+\.[a-zA-Z0-9\-]+|[a-zA-Z0-9\-]+)\.[a-zA-Z\.]{2,6}|[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})(\/[a-zA-Z0-9\.\?=\/#%&\+-]+|\/|)/i.test(arguments[0].value))}';
	}
