...
class mFieldType_captcha extends mFieldType
{
	...
	function getInputHTML()
	{
		...
		else
		{
			...
			$html .= 'document.getElementById(\'mtForm\').onsubmit=function(){if(typeof document.mtForm.'.$this->getInputFieldName(1).' != \'undefined\'){document.mtForm.'.$this->getInputFieldName(1).'.value=document.mtForm.recaptcha_response_field.value;}}';
			$html .= '</script>';
