...
$doc->addScript($this->baseurl.'/templates/'.$this->template.'/javascript/chosen.jquery.js', 'text/javascript', true);
...
<?php endif; ?>
<html class="ml" xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	<head>
...
<?php } ?>
		...
		<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/css/chosen.css" type="text/css" />	
	...
	<?php if(!$templateparams->get('html5', 0)): ?>
			...
			<?php else: ?>
				...
				<div id="header-image" style="display:none;">
					...
					<?php if ($this->countModules('position-15')==0): ?>
						<img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/images/inncubated-2.png"  alt="<?php echo JText::_('TPL_BEEZ5_LOGO'); ?>" />
					<?php endif; ?>
				</div>
				<?php if (!$templateparams->get('html5', 0)): ?>
					</div><!-- end header -->
		...
		<?php endif ; ?>
			...
			<?php endif; ?>
					...
					<p>
						<?php echo JText::_('TPL_BEEZ5_POWERED_BY');?> <a href="http://www.inncubated.com/">InncubatED&#174;</a>
					</p>
