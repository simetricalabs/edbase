...
?><div class="reviews">
	...
	?>
	<div itemprop="reviews" itemscope itemtype="http://schema.org/Review" class="review"><div class="review-head"><?php
	...
	<p class="mbutton">
		<a href="<?php echo JRoute::_('index.php?option=com_mtree&task=writereview&link_id='.$this->link->link_id); ?>"><?php echo JText::_( 'COM_MTREE_WRITE_REVIEW' ); ?><span class="lucida button-arrow">»</span></a>
	</p>
	<?php
	}
	...
	if(isset($this->reviewsNav))
	{
		...
		<div class="pages-links">
			<span class="xlistings"><?php echo $this->reviewsNav->getResultsCounter(); ?></span>
	...
	{
		?>
		<a href="<?php echo JRoute::_('index.php?option=com_mtree&task=viewreviews&link_id='.$this->link->link_id); ?>"><?php echo JText::sprintf('COM_MTREE_SEE_ALL_N_REVIEWS',$this->total_reviews); ?></a>
		<?php
	}
	?>
	...
	if( !isset($hide_submitreview) || $hide_submitreview == false ) { ?>
	<p class="mbutton">
		<a rel="nofollow" href="<?php echo JRoute::_('index.php?option=com_mtree&task=writereview&link_id='.$this->link->link_id); ?>"><?php echo JText::_( 'COM_MTREE_BE_THE_FIRST_TO_REVIEW' ); ?><span class="lucida button-arrow">»</span></a>
	</p>
	<?php 
	}
