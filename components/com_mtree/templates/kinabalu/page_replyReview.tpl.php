...
<table border="0" cellpadding="3" cellspacing="0">
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="<?php echo JText::_( 'COM_MTREE_SEND' ) ?>" onclick="javascript:submitbutton('send_replyreview')" class="button" /> <input type="button" value="<?php echo JText::_( 'COM_MTREE_CANCEL' ) ?>" onclick="javascript:submitbutton('cancel')" class="button" />
		</td>
	</tr>
</table>
</form>
