...
<div class="users-reviews-active"><span><?php echo JText::_( 'COM_MTREE_REVIEWS' ) ?></span>(<?php echo $this->pageNav->total ?>)</div>
...
<?php if (is_array($this->reviews) && !empty($this->reviews)) { ?>
	...
	<div class="review">
		...
		if( $review->vote_total > 0 ) { 
			echo JText::sprintf( 'People find this review helpful', $review->vote_helpful, $review->vote_total );
		}
		echo '</span>';
		echo '</div>';
