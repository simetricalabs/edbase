<?php
/**
 * @version	$Id: listlisting.php 1661 2012-12-14 08:25:26Z cy $
 * @package	Mosets Tree
...
class mtListListing {
	...
	var $allowed_sort = array('link_created','link_modified','link_hits','link_visited','link_rating','link_votes','link_name','price');
	...
	function getSortHTML() {
		...
		return JHtml::_(
			...
			$options,
			'sort',
			array('list.attr' => 'id="sort" class="inputbox" size="1" '. $javascript, 'list.select' => $this->sort)
		);
	}
